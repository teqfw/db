...
Configures connections, owns the root schema map, resolves the DI graph, and invokes persistence and rebuild services.
...
Runs structure initialization, drop, export, import, rebuild, connection shutdown, and database-specific operational preparation.
...
Preserves cross-engine behavior, declaration compatibility, transaction invariants, rebuild boundaries, and the public TeqFW namespace.
